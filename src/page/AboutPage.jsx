            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-1/2 md:pl-10">
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed text-start ">
                  Kami menyediakan tempat belanja serba ada untuk semua
                  kebutuhan Anda! Dari pakaian trendi, gadget canggih, hingga
                  peralatan rumah tangga dan produk kecantikan, kami hadir
                  dengan beragam pilihan berkualitas. Menyediakan layanan
                  belanja yang cepat, aman, dan nyaman, kami memastikan Anda
                  mendapatkan produk impian tanpa repot. Dengan harga bersaing,
                  promo menarik, dan pengiriman yang andal, kepuasan Anda adalah
                  prioritas utama kami. Apa pun yang Anda cari, toko kami adalah
                  solusi belanja terbaik untuk memenuhi gaya hidup modern Anda.
                  Yuk, temukan semuanya hanya di sini!
                </p>
              </div>
            </div>
          </section>
